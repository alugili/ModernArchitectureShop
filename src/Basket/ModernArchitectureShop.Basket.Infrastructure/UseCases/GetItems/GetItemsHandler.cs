...
{
    internal class GetItemsHandler : IRequestHandler<GetItems, GetItemsCommandResponse>
    {
        ...
        public async Task<GetItemsCommandResponse> Handle(GetItems command, CancellationToken cancellationToken)
        {
